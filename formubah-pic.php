        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" style="background-color:#ffefec">
                ...
                <div class="container-fluid">
                    ...
                    $sql = mysqli_query($conn, "SELECT * FROM tb_pic WHERE id_pic = '$_GET[update]'");
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <form action="" method="POST">
                                <h3 class="text-center" style="margin-bottom:1rem; font-weight:bold;">Form Ubah Data PIC</h3>
                                    ...
                                    <div class="col-8">
                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-md-5"  style="margin-top:7px;">
                                                <input type="text" name="notlp_pic" class="form-control" value="<?php echo $row['notlp_pic']; ?>">
                                            </div>
                                        </div>
                    ...
                    if (isset($_POST['ubah'])) {
                        ...
                        $notlpPIC = $_POST['notlp_pic'];

                        $update = mysqli_query($conn, "UPDATE tb_pic SET 
                                                                    nama_pic = '$namaPIC', 
                                                                    notlp_pic = '$notlpPIC'
                                                                    WHERE id_pic = '$_GET[update]'");

                        if ($update) {
                            echo "<script>
                            alert('Berhasil Ubah Data PIC!');
                            document.location='pic.php';
                            </script>";
                        } else {
                            echo "<script>
                            alert('Gagal Ubah Data PIC!');
                            document.location='formubah-pic.php?update=$idPIC';
                            </script>";
                        }
                    }
